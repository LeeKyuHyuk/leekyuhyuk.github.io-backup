! function e(t, n, r) {
    ...
    8: [function(require, module, exports) {
		...
		appendToResultsContainer("<br>");
                if (0 === results.length)
			return appendToResultsContainer("<h2 class=\"widget-title\">" + options.noResultsText + "</h2>");
		appendToResultsContainer("<h2 class=\"widget-title\">검색 결과:</h2>");
